...
const OverView: React.FC = () => {
  return (
    <div
      className="bg-gradient-to-r from-red-400 to-red-800 text-white text-center py-16"
      id="about"
    >
      <h1 className="text-3xl font-bold ">
        ...
        developers at{" "}
        <span className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-800 to-black">
      ...
      <div className="py-2 my-2 justify-between mt-8">
        ...
        <p className="mt-6 font-serif ">
          Edem-Tech Ent for the past 2 years have been developing Responsive
          websites, web applications and systems for it's clients. Do not
          hesitate to contact Edem-Tech Enterprise for any IT services
          <p>Edem-Tech is ever ready to contact you for any development.</p>
          <p>
            We specialize in web application development with good responsive
            features.
          </p>
        </p>
