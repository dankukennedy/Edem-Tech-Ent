...
const Footer:React.FC = () => {
  ...
  return (
    <footer className='bg-gradient-to-r from-black to-blue-950 text-white py-8' id='footer'>
        <div className='container  mx-auto px-8 md:px-16 lg:px-24' >
            <div className='flex flex-col md:flex-row md:space-x-12 items-center mb-4' >
                <div className='flex-1 mb-4 md:mb-0'>
                <h3 className='text-2xl font-bold mb-2'>Edem-Tech Enterprise</h3>
                <p className='text-gray-400'>
                    Full-Stack Developers based in Accra Ghana, specializing in web and software development
                </p>
               </div>
            ...
            <div className='border-t border-gray-600 pt-4 flex flex-col md:flex-row justify-between items-center'>
                <p className='text-gray-400'>
                  Copyright  &copy; {new Date().getFullYear()} Edem-Tech Ent. All right reserved.
                </p>
